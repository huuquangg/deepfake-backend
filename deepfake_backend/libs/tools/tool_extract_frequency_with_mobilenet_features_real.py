"""
Extract Frequency + MobileNet features for REAL dataset
Save separately for multi-input training
"""
# /Applications/Tien/deepfake-backend/deepfake-backend/deepfake_backend/libs/tools/tool_extract_frequency_with_mobilenet_features_real.py
...
# CONFIG - REAL DATASET
# =========================
FOLDER_PATH = "/Applications/Tien/deepfake/Dataset/celeb_df_crop/real"
OUTPUT_DIR = "/Applications/Tien/deepfake/Dataset/features/real"
CHECKPOINT_FILE = "checkpoint_real.txt"
...
def main():
    ...
    print("="*80)
    print("EXTRACT REAL DATASET - Save separately")
    print("="*80)
    ...
    # Summary
    print("\n" + "="*80)
    print("REAL DATASET - EXTRACTION COMPLETE")
    print("="*80)
