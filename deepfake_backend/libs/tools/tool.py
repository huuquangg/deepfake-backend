...
folder_path = "/home/huuquangdang/huu.quang.dang/thesis/Dataset/facep/faceplus_processed_research_final_2_crop/fake"
output_csv = "fpp_fake_v1.csv"
        ...
        async with aiohttp.ClientSession(connector=connector, timeout=timeout) as session:
            ...
            for batch_num, batch in enumerate(batches, start=1):
                ...
                for fname, data_row in results:
                    if data_row:
                        # Prepend the filename to the row
